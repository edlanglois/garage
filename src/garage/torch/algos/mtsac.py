...
class MTSAC(SAC):
    ...
    Args:
        ...
        alpha (float): The entropy/temperature coefficient to be used if
        ...
        initial_log_entropy (float): The initial entropy/temperature
            coefficient to be used if use_automatic_entropy_tuning is True.
    ...
    def __init__(
        ...
        if self._use_automatic_entropy_tuning and not alpha:
            if target_entropy:
            ...
            self._log_alpha = torch.Tensor([alpha]).log()
