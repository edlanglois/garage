...
from tests.benchmarks.auto.experiments.ppo_garage_pytorch \
    import ppo_garage_pytorch
...
from tests.benchmarks.auto.experiments.trpo_garage_pytorch \
    import trpo_garage_pytorch
from tests.benchmarks.auto.experiments.trpo_garage_tf import trpo_garage_tf
from tests.benchmarks.auto.experiments.vpg_garage_pytorch \
    import vpg_garage_pytorch
